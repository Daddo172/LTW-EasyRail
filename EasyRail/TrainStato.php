...
<header class="topnav">
	...
	<main>
		<form action="TrainStatus.php" method="post" onsubmit="return validaCT();" style="margin: 60px auto 60px auto; min-width: 200px;">
			...
			<div id="messaggioCT" style="color: rgb(200, 0, 0); text-align: center;"></div>
			<p>
