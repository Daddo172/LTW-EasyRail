                ...
                <div class="card-body">
					...
					<tr>
                        <p>
                            ...
                            <td><input type="text" name="inputarrivo" value="<?php echo $row['destinazione'];?>" id="nome" required></td>
                        </p>
                    </tr>
					<tr>
                        <p>
                            <td><label for="orariopart">orario partenza </label></td>
                            <td><input type="time" name="inputorariopart" value="<?php echo $row['hpartenza'];?>" id="nome" required></td>
                        </p>
                    </tr>
					<tr>
                        <p>
            ...
            <DIV class="card">
                ...
                <div class="card-body">
                    ...
                    <tr>
                        <p>
                            <td><label for="codice">codice</label></td>
                            <td><input type="text" name="updatecodice2" value="<?php echo $row['codice'];?>" id="nome" readonly></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Fermata N°0</label></td>
                            <td><input type="text" name="inputfermata0" value="<?php echo $row['f0'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Fermata N°1</label></td>
                            <td><input type="text" name="inputfermata1" value="<?php echo $row['f1'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Fermata N°2</label></td>
                            <td><input type="text" name="inputfermata2" value="<?php echo $row['f2'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Fermata N°3</label></td>
                            <td><input type="text" name="inputfermata3" value="<?php echo $row['f3'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Fermata N°4</label></td>
                            <td><input type="text" name="inputfermata4" value="<?php echo $row['f4'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Fermata N°5</label></td>
                            <td><input type="text" name="inputfermata5" value="<?php echo $row['f5'];?>" id="nome" required></td>
                        </p>
                    </tr>
					<tr>
                        <p>
                            <td><label for="fermata">Orario Fermata N°0</label></td>
                            <td><input type="time" name="inputhfermata0" value="<?php echo $row['hf0'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Orario Fermata N°1</label></td>
                            <td><input type="time" name="inputhfermata1" value="<?php echo $row['hf1'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Orario Fermata N°2</label></td>
                            <td><input type="time" name="inputhfermata2" value="<?php echo $row['hf2'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Orario Fermata N°3</label></td>
                            <td><input type="time" name="inputhfermata3" value="<?php echo $row['hf3'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Orario Fermata N°4</label></td>
                            <td><input type="time" name="inputhfermata4" value="<?php echo $row['hf4'];?>" id="nome" required></td>
                        </p>
                    </tr>
                    <tr>
                        <p>
                            <td><label for="fermata">Orario Fermata N°5</label></td>
                            <td><input type="time" name="inputhfermata5" value="<?php echo $row['hf5'];?>" id="nome" required></td>
                        </p>
                    </tr>
                </table>
                        <p>
