                ...
                <table class="table table-bordered">
                    ...
                    {?>
                        <tr>
                            ...
                            <td><?php echo  $row['andata']; ?></td>
                            <td><?php echo $row['passeggeri']; ?></td>
                            <td><?php echo $row['orariopartenza']; ?></td>
                            <td><?php echo $row['orarioarrivo']; ?></td>
                            <td> 
                                <a href="edit.php?codice=<?php echo $row['codice']; ?>" class="btn btn-success">Modifica dati</a>
                            </td>
                            <td> 
